...
## Usage
  This application works like a standard website. Please click on the link here:(https://jennastrom.github.io/react-portfolio-jenna/#portfolio) and then you can navigate to different pages using the links in the navbar.   
